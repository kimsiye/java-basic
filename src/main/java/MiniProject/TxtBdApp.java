...
//        in.setBody(boardContent);
    ...
    public void detail() {
        ...
        if (detailSelNum < 0 || detailSelNum >= PostsList.size()) {
            ...
            detailPrint(detailPost);
            commentChoice(detailPost);
    ...
    //-------------------------------------------
    public void detailPrint(Post detailPost) {
        ...
        detailPost.commentReturn();


    }

    public void commentChoice(Post detailPost){
        while(true) {
