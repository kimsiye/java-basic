...
// 고무오리로 부모로 정의하고 날다 매서드를 바꾼다.
// 아쉬운점 공통분모의 각각을 받을 수가 없다.

// 상속의 한계 : 부모가 둘이 될 수는 없음(단일상속)
// 객체가 많아지고 상속 관계가 복잡해질 수록 중복 해결이 어려워진다.
// 상속은 잘못 사용하면 큰일난다.

// 상속 하나를 고치면 받는 모든 클래스들이 고칠 때 어려워진다.
// 위험해질 수 있어서 함부로 남용하면 안됨
